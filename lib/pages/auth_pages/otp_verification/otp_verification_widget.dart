                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Align(
                              alignment: const AlignmentDirectional(-1.0, 0.0),
                              child: Text(
                                'We will send you the code verification to you mobile number ${widget.number}',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      fontFamily: 'Roboto',
                            ...
                            Padding(
                              ...
                              child: PinCodeTextField(
                                ...
                                validator:
                                    _model.otpValidator.asValidator(context),
                              ),
                            ),
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      ...
                                      if (_model.timerMilliseconds == 0) {
                                        _model.result = await actions.resendOtp(
                                          widget.number!,
                                        );
                                        shouldSetState = true;
                                      } else {
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    var shouldSetState = false;
                                    _model.success = await actions.confirmOtp(
                                      _model.otp!.text,
                                      widget.number!,
                                    );
                                    shouldSetState = true;
                                    if (_model.success!) {
                                      _model.set = await actions.checkAuth();
                                      shouldSetState = true;
                                      if (_model.set == true) {
