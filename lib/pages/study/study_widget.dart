...
import '/components/videos_card_widget.dart';
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (_model.selectedVideo != null &&
                              _model.selectedVideo != '')
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 20.0, 0.0, 0.0),
                              child: FlutterFlowYoutubePlayer(
                                url: _model.selectedVideo!,
                                autoPlay: false,
                                looping: true,
                                mute: false,
                                showControls: true,
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 20.0, 0.0, 0.0),
                                  child: FutureBuilder<List<StudyRow>>(
                                    future: StudyTable().queryRows(
                                      queryFn: (q) => q,
                                    ),
                                    builder: (context, snapshot) {
                                      ...
                                      List<StudyRow> listViewStudyRowList =
                                          snapshot.data!;

                                      return ListView.builder(
                                        padding: EdgeInsets.zero,
                                        scrollDirection: Axis.vertical,
                                        itemCount: listViewStudyRowList.length,
                                        itemBuilder: (context, listViewIndex) {
                                          final listViewStudyRow =
                                              listViewStudyRowList[
                                                  listViewIndex];
                                          return InkWell(
                                            splashColor: Colors.transparent,
                                            focusColor: Colors.transparent,
                                            ...
                                            child: VideosCardWidget(
                                              key: Key(
                                                  'Keywp5_${listViewIndex}_of_${listViewStudyRowList.length}'),
                                              image: listViewStudyRow.imageUrl!,
