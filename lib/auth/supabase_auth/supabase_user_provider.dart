...
class LearnCarSupabaseUser extends BaseAuthUser {
  LearnCarSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> learnCarSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = LearnCarSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
